...
('p-001', 'Burger Bò Nướng', 'Burger bò nướng phô mai', 75.00, 'c-001', 'http://localhost:3000/api/upload/BurgerBoNuong.jpg', 'r-001', 1),
('p-002', 'Pizza Hải Sản', 'Pizza hải sản thập cẩm', 100.00, 'c-002', 'http://localhost:3000/api/upload/PizzaHaiSan.png', 'r-002', 1),
('p-003', 'Pepsi', 'Nước ngọt có ga', 15.00, 'c-003', 'http://localhost:3000/api/upload/Pepsi.jpg', 'r-001', 1),
('p-004', 'Gà Rán Giòn', 'Gà rán tẩm bột giòn tan', 87.00, 'c-005', 'http://localhost:3000/api/upload/GaRanGion.jpg', 'r-001', 1),
('p-005', 'Mỳ Ý Spaghetti', 'Mỳ Ý sốt bò bằm truyền thống', 68.00, 'c-002', 'http://localhost:3000/api/upload/MiY.jpg', 'r-002', 1),
('p-006', 'Coca-Cola', 'Nước ngọt có ga', 15.00, 'c-003', 'http://localhost:3000/api/upload/Coca.jpg', 'r-002', 1),
('p-007', 'Burger Gà', 'Burger gà chiên xù', 65.00, 'c-001', 'http://localhost:3000/api/upload/BurgerGa.jpg', 'r-001', 1),
('p-008', 'Pizza Bò', 'Pizza bò và nấm', 110.00, 'c-002', 'http://localhost:3000/api/upload/PizzaBoNam.jpg', 'r-001', 1),
('p-009', 'Sprite', 'Nước ngọt có ga vị chanh', 10.00, 'c-003', 'http://localhost:3000/api/upload/Sprite.jpg', 'r-002', 1),
('p-010', 'Khoai Tây Chiên', 'Khoai tây chiên giòn rụm', 45.00, 'c-005', 'http://localhost:3000/api/upload/KhoaiChien.jpg', 'r-001', 1),
('p-011', 'Nước Cam', 'Nước cam nguyên chất siêu ngon', 16.00, 'c-004', 'http://localhost:3000/api/upload/NuocCam.jpg', 'r-001', 1),
('p-012', 'Nước Chanh', 'Chanh tươi siêu mát', 10.00, 'c-004', 'http://localhost:3000/api/upload/NuocChanh.jpg', 'r-001', 1),
('p-013', 'Cơm chiên dương châu', 'Ăn 3 tô cơm', 62.00, 'c-006', 'http://localhost:3000/api/upload/ComChienDuongChau.jpg', 'r-001', 1),
('p-014', 'Black Bean Noodles', 'My tuong den', 72.00, 'c-007', 'http://localhost:3000/api/upload/BlackBeanNoodles.jpg', 'r-001', 1);
